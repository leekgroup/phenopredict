...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/merge_input_AGE.rda")){
	...
	inputdata<-select_regions(expression=cm, regiondata=regiondata ,phenodata=pheno, phenotype="AGE",
	    covariates=c("Sex","BMI","SMNABTCHT"),type="numeric", numRegions=40)
...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/merge_input_AGE.rda")) {
	...
	load("/dcl01/leek/data/sellis/barcoding/data/merge_input_AGE.rda")
}
...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/predictor_AGE.rda")) {
	predictor<-build_predictor(inputdata=merge_input ,phenodata=pheno, phenotype="AGE",		 
    	covariates=c("Sex","BMI","SMNABTCHT"),type="numeric", numRegions=40)
	save(predictor, file="/dcl01/leek/data/sellis/barcoding/data/predictor_AGE.rda")
}else{
	load("/dcl01/leek/data/sellis/barcoding/data/predictor_AGE.rda")
}
...
predictions_test <-test_predictor(inputdata=merge_input ,phenodata=pheno, phenotype="AGE", 
    covariates=c("Sex","BMI","SMNABTCHT"),type="numeric",predictordata=predictor )
...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/test_data_AGE.rda")) {
	load("data/cm_new.Rda")
	...
	for(i in 1:length(chrs)){
		...
		save(merge_test,file="/dcl01/leek/data/sellis/barcoding/data/test_data_AGE.rda")
		# for(i in 1:length(chrs)){
		# 	chrname=paste0("chr",chrs[i])
	...
	load("/dcl01/leek/data/sellis/barcoding/data/test_data_AGE.rda")
...
predictions<-predict_pheno(inputdata_test= merge_test, phenodata=pheno2,covariates=c("Sex","BMI","SMNABTCHT"), phenotype="AGE",type="numeric",predictordata = predictor)
