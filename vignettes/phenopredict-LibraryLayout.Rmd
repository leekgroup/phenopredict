---
title: "Sequencing Library Prediction"
...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/SRA_inputdata_LibraryLayout.Rdata")){
	...
	merge_input$covmat = dplyr::select(merge_input$covmat, -(.id))
	  ...
	  save(merge_input,file='/dcl01/leek/data/sellis/barcoding/data/SRA_inputdata_LibraryLayout.Rdata')
	}else{
	  load('/dcl01/leek/data/sellis/barcoding/data/SRA_inputdata_LibraryLayout.Rdata')
	}
...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/build_predictor_LibraryLayout_nocovars.rda")) {
	...
	save(predictor, file= "/dcl01/leek/data/sellis/barcoding/data/build_predictor_LibraryLayout_nocovars.rda")
}else{
	load('/dcl01/leek/data/sellis/barcoding/data/build_predictor_LibraryLayout_nocovars.rda')
}
...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/sra_test_inputdata_LibLayout_nocovars.rda")) {
	...
	save(sra_test_inputdata, file= "/dcl01/leek/data/sellis/barcoding/data/sra_test_inputdata_LibLayout_nocovars.rda")
}else{
	load('/dcl01/leek/data/sellis/barcoding/data/sra_test_inputdata_LibLayout_nocovars.rda')
}
```

# Predict Library Type in SRA test set
...
# export.bed(gr, con="/dcl01/leek/data/sellis/barcoding/TCGA/TCGA_LibraryLayout_v2.bed")

## run scripts/run_bwtool_LibraryLayout.sh to extract regions
# system('sh /dcl01/leek/data/sellis/barcoding/scripts/run_bwtool_LibraryLayout.sh tcga')
# data are here: /dcl01/leek/data/sellis/barcoding/TCGA/bwtool_LibraryLayout/coverage_tcga_LibraryLayout
...
tcga_test_inputdata = list()
tcga_test_inputdata$covmat <- log2(covmat+1)
tcga_test_inputdata$regiondata <- regions

predictions_gtex<-predict_pheno(inputdata_test= tcga_test_inputdata, phenodata=sra_meta_training, phenotype=phenot, covariates=NULL,type="factor", predictordata = predictor)
...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/sra_test_inputdata_LibLayout_nocovars.rda")) {
	...
	output
	save(output, file= "/dcl01/leek/data/sellis/barcoding/output/LibraryLayout_regions.rda")
}else{
	load("/dcl01/leek/data/sellis/barcoding/output/LibraryLayout_regions.rda")
...
## Create the vignette
library('rmarkdown')
system.time(render('/users/sellis/phenopredict/vignettes/phenopredict-LibraryLayout.Rmd', 'BiocStyle::html_document'))

## Extract the R code
library('knitr')
knit('/users/sellis/phenopredict/vignettes/phenopredict-LibraryLayout.Rmd', tangle = TRUE)
```
